...
-   [ ] DailyReport verify by admin, in index and in show, not has sweetalert and return redirect
-   [ ] DailyReport->create->status tickets not consistent and show on yet 
...
-   [ ] Fix Every Table, add paginate and add searching 
