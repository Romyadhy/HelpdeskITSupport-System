...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/PHP-8.3.11-777BB4?style=for-the-badge&logo=php&logoColor=white" alt="PHP 8.3.11">
...
-   **Language:** PHP 8.3.11
-   **Database:** MySQL
-   **Frontend:** Blade Templates, [TailwindCSS](https://tailwindcss.com), [Alpine.js](https://alpinejs.dev)
-   **Libraries & Packages:**
    -   [Spatie Permission](https://spatie.be/docs/laravel-permission) (Role Management)
    -   [Spatie Activitylog](https://spatie.be/docs/laravel-activitylog) (System Logging)
