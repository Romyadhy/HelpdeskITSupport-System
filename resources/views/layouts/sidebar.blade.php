        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="mt-6 flex-1 px-4 space-y-3 overflow-y-auto">
                ...
                <a href="{{ route('dashboard') }}" wire:navigate
                    ...
                    {{ request()->routeIs('dashboard') ? 'bg-emerald-600 text-white shadow-md' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                ...
                @can('view-handbook')
                    <a href="{{ route('handbook.index') }}" wire:navigate
                        class="flex items-center px-4 py-3 rounded-lg transition-all duration-200
                ...
                <a href="{{ route('tickets.index') }}" wire:navigate
                    class="flex items-center px-4 py-3 rounded-lg transition-all duration-200
                    {{ is_active(['tickets.index', 'tickets.create', 'tickets.show', 'tickets.edit']) ? 'bg-emerald-600 text-white shadow-md' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="px-4 pb-6 border-t border-gray-700/50">
                <div class="relative mt-6" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100"
                        ...
                        style="display: none;">
                        {{-- 🔹 Profile pakai wire:navigate karena halaman biasa --}}
                        <x-dropdown-link :href="route('profile.edit')" wire:navigate>
                            {{-- {{ __('Profile') }} --}} Profile
                        </x-dropdown-link>

                        {{-- 🔹 Logout JANGAN wire:navigate (karena POST form) --}}
