<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            {{-- Tombol Upload hanya muncul jika user punya izin --}}
            @can('create-handbook')
                <div class="flex justify-end mb-6">
                    <a href="{{ route('handbook.create') }}"
                        class="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg shadow-md flex items-center gap-2 transition duration-200">
