<x-app-layout>
    {{-- ================= HEADER ================= --}}
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tugas Harian</h2>
    </x-slot>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="p-2">
                            <h3 class="text-lg font-semibold text-gray-700">📅 Tugas Harian</h3>
        ...
        window.taskManagement = function() {
            return {
                ...
                createFormData: {
                    title: '',
                    description: '',
                    frequency: 'daily', // Default for daily page
                    is_active: true
                },
