            ...
            <form id="createTaskForm" method="POST" action="{{ route('tasks.store') }}">
                ...
                <div class="mb-5">
                    ...
                    <x-text-input id="title" name="title" type="text" required
                        placeholder="e.g., Backup daily server logs" value="{{ old('title') }}"
                ...
                <div class="mb-5">
                    ...
                    <textarea id="description" name="description" rows="5" required placeholder="Describe what this task is for..."
                ...
                <div class="mb-5">
                    ...
                    <select id="frequency" name="frequency" required
                        ...
                        <option value="" disabled {{ old('frequency') ? '' : 'selected' }}>Select Frequency
                        </option>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Only active tasks will appear in the daily/monthly task list.
                    </p>
                </div>
